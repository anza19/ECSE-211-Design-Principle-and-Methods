...
public class Odometer extends Thread {
	...
	public void run() {
		...
		while (true) {
			...
			double rightDistance = (2*Math.PI*Lab2.WHEEL_RADIUS*(rightMotorTachoCount-last_tacho_r))/360;
			double leftDistance = (2*Math.PI*Lab2.WHEEL_RADIUS*(leftMotorTachoCount-last_tacho_l))/360;
			...
			delta_T = (leftDistance-rightDistance)/Lab2.TRACK;
